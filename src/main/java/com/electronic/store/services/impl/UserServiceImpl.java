...
public class UserServiceImpl implements UserService {
	...
	public UserDto updateUSer(UserDto userDto, String userId) {
		User user = userRepository.findById(userId)
				.orElseThrow(() -> new RuntimeException("User not found with given userId."));
	...
	public UserDto getUserByEmail(String email) {
		User user = userRepository.findByEmail(email).orElseThrow(() -> new RuntimeException("User not found with given emailId."));
		UserDto userDto = mapEntityToDto(user);
		return userDto;
	}
